<template>
  <div class="col-12 myFont">
    <div
      class="col-12 text-bold text-center"
      :class="$q.screen.gt.sm ? 'text-h2' : 'text-h6'"
      :style="{
        'padding-top': $q.screen.gt.sm ? '120px' : '50px',
      }"
    >
      Autonomous Vehicle AI Solutions
    </div>
    <div
      class="col-12 text-center"
      :style="{
        'padding-top': '20px',
        margin: $q.screen.gt.sm ? '0' : '0 10px',
      }"
    >
      We provide Autonomous Vehicle AI Solutions to improve driving safety and
      automation through advanced artificial intelligence.
    </div>

    <div
      class="row justify-center items-center q-mt-lg q-mb-lg"
      style="margin-top: 100px"
    >
      <div class="col-12 col-md-6 flex flex-center">
        <q-img
          src="assets/imageDekstop/serviceAutonomus.png"
          style="width: 60%"
        ></q-img>
      </div>

      <div class="col-12 col-md-6 flex flex-center column">
        <div class="text-h3 q-mb-lg text-center" style="margin-bottom: 50px">
          Innovative Features
        </div>
        <div class="row q-gutter-lg justify-center">
          <div
            class="col-12 q-my-md flex flex-center"
            v-for="i in partAutonomus"
            :key="i.title"
          >
            <q-card
              class="text-left q-py-md q-px-md full-height"
              :style="{
                'max-width': $q.screen.gt.sm ? '500px' : '300px',
                width: '100%',
                'border-radius': '16px',
                background: 'linear-gradient(135deg, #d9ab6d, #b97c4a)',
              }"
            >
    ...
    <div class="col-12 q-px-md">
      <div
        ...
        :style="{
          ...
          'margin-top': $q.screen.lt.md ? '50px' : '100px',
        }"
      >
        <div
        ...
        >
          <div
            class="text-bold"
            :class="$q.screen.lt.md ? 'text-h4' : 'text-h2'"
          >
            Example Products
          </div>
          <div
        ...
        >
          <div :class="$q.screen.lt.md ? 'text-subtitle1' : 'text-h6 '">
            Whether it's AI-powered dashboards or autonomous navigation, we
    ...
    >
      <q-card
        v-for="p in exampleAutonomus"
        :key="p.id"
        class="col-12 col-md-5 q-pa-md q-ma-sm text-white"
        style="border-radius: 20px; background-color: #1d2939"
        :style="{
          maxWidth: $q.screen.lt.sm ? '300px' : '500px',
          margin: $q.screen.lt.md ? '10px 20px' : '100px 50px',
        }"
      >
        <q-card-section>
          <div
...
import { partAutonomus, exampleAutonomus } from '../pages/ServicePage';
